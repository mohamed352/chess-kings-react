    ...
    <footer className="bg-white border-t border-gray-100 pt-16 pb-8" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 items-start">
          ...
          {/* Left Column: Newsletter & Socials (Inside Gray Box) (Last Child = Leftmost in RTL) */}
          <div className="bg-[#F8F9FA] rounded-[24px] p-8">
            <h3 className="text-lg font-bold text-gray-700 mb-6 text-center">ابق مطلع على جديد شطارة</h3>
            <form className="flex items-center gap-2 mb-8" onSubmit={(e) => e.preventDefault()}>
              <button
                type="submit"
                className="whitespace-nowrap px-4 py-2.5 rounded-lg bg-[#AB86B9] text-white text-sm font-bold hover:bg-[#AB86B9]/90 transition-colors"
              >
                إشترك الآن
              </button>
              <input
                ...
                className="flex-1 min-w-0 px-4 py-2.5 rounded-lg bg-white border border-gray-200 focus:outline-none focus:border-[#AB86B9] transition-colors text-right text-sm"
              />
            </form>

            <div className="space-y-4 text-center">
              <h4 className="text-sm font-bold text-gray-700">حسابات شطارة</h4>
              <div className="flex items-center justify-center gap-3">
                {footerLinks.socials.map((social, idx) => (
                  <Link
                    ...
                    className="w-10 h-10 rounded-lg bg-[#AB86B9] text-white flex items-center justify-center hover:bg-[#AB86B9]/90 transition-all hover-lift"
                  >
